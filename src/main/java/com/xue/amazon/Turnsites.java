...
public class Turnsites {
	...
	public static void main(String[] args){
		...
		Turnsites.test(obj.getTimes(new int[]{1, 1, 2, 6}, new int[]{0, 1, 1, 0}), new int[]{3, 1, 2, 6});
		Turnsites.test(obj.getTimes(new int[]{1, 2, 2, 4, 4}, new int[]{0, 1, 0, 0, 1}), new int[]{1, 3, 2, 5, 4});
	}
}
